...
class CarRacingEnvironment:
    ...
    def reset(self):
        ...
        # print("track")
        # self.map_count += 1
        # filename = f"pic/track_start_{self.map_count}.png"
        # Save the first observation as an image
        # success = cv2.imwrite(filename, cv2.cvtColor(obs, cv2.COLOR_RGB2BGR))
        # if success:
        #     print("Image successfully written to 'output_image.png'")
        # else:
