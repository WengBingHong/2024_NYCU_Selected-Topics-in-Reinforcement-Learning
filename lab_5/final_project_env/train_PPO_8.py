...
if __name__ == "__main__":
    ...
    # # 加載預訓練模型
    # pretrained_model = PPO.load("log/train6/train_PPO_6/PPO_6/best_model_austria.zip")
    ...
    # 開始訓練
    model.learn(
        total_timesteps=5e6, log_interval=10, callback=eval_callback, progress_bar=True
    )
